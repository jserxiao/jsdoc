...
| 文档 | 说明 |
|------|------|
| [GitHub Actions](./01-GitHub-Actions.md) | GitHub 原生 CI/CD |
| [GitLab CI](./02-GitLab-CI.md) | GitLab 内置 CI/CD |
| [Jenkins](./03-Jenkins.md) | 开源自动化服务器 |
| [Vercel 部署](./04-Vercel部署.md) | 前端快速部署平台 |
| [Docker 容器化](./05-Docker容器化.md) | Docker 部署方案 |
| [环境变量管理](./06-环境变量管理.md) | Secrets 与环境配置 |
