...
| 文档 | 说明 |
|------|------|
| [组件设计原则](./组件设计原则.md) | 单一职责、可复用性、可扩展性 |
| [组件通信方式](./组件通信方式.md) | Props、Events、Provide/Inject 等 |
| [组件库开发](./组件库开发.md) | 组件库架构设计与开发流程 |
| [组件文档](./组件文档.md) | Storybook、VitePress 文档 |
| [组件测试](./组件测试.md) | 单元测试、组件测试策略 |
