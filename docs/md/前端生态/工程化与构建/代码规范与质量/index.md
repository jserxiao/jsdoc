...
| 文档 | 说明 |
|------|------|
| [ESLint](./ESLint.md) | JavaScript/TypeScript 代码检查 |
| [Prettier](./Prettier.md) | 代码格式化工具 |
| [TypeScript 类型检查](./TypeScript类型检查.md) | 类型安全配置 |
| [Git 提交规范](./Git提交规范.md) | Commitlint 提交信息规范 |
| [Git Hooks](./Git-Hooks.md) | Husky + lint-staged 自动检查 |
| [EditorConfig](./EditorConfig.md) | 编辑器配置统一 |
